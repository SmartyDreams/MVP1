...
- Once the infrastructure is created, you can run the kubes playbooks and supply inventory/hosts with the `-i` flag.
...
![AWS Infrastructure with Terraform  ](docs/aws_kube.png)
