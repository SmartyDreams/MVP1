...
kubernetes_api_dns_name = kubernetes-1992796151.us-east-1.elb.amazonaws.com
kubernetes_workers_public_ip = 3.85.50.113,3.82.210.64,3.84.103.89
...
```
$ change data on terraform.tfvars
$ sudo terraform init ./terraform
$ sudo terraform plan ./terraform
$ sudo terraform apply ./terraform
```
...
```
$ sudo ansible-playbook --private-key=~/Desktop/workspace/fastDataPlatform.pem  infra.yaml
...
$ ansible-playbook kubectl.yaml --extra-vars "kubernetes_api_endpoint=kubernetes-1992796151.us-east-1.elb.amazonaws.com"
...
```
$ sudo ansible-playbook --private-key=~/Desktop/workspace/fastDataPlatform.pem kubernetes-routing.yaml
```
...
$ sudo ansible-playbook --private-key=~/Desktop/workspace/fastDataPlatform.pem kubernetes-nginx.yaml
